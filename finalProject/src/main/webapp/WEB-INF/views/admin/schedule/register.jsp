...
<body>
	...
	<h2>스케줄 등록</h2>
	  ...
	  <form action="register" method="post">
	  	<p>영화 선택</p>
	  	<!-- // TODO : mvId운종이가 비동기로 영화목록을 가져와서 select for문으로 만드는데, 현재 누른시점날짜와 비교해서 상영중인 영화목록만 가져와야함 -->
	    <p>상영 지점 및 상영관 선택</p>
	  	<!-- // TODO : brcId운종이가 비동기로 지점목록을 가져와서 select for문으로 만듬 근데 중복선택가능해야함(3중반복문 제일외곽)-->
